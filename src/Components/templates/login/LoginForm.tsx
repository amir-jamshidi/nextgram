...
import { loginSchema, veifySchema } from "@/Utils/Schemas";
import React, { useState } from "react";
import { handleLoginForm, handleVerifyForm } from "@/libs/postRequests";
...
const LoginForm = () => {
  ...
  const handleLogin = (values: {}) => {
    handleLoginForm(values, (response: { phone: string }) => {
